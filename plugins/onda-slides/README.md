...
내부 회의, 팀 보고 등 정보 밀도가 높은 프레젠테이션용.
...
### `/onda-slides-simple` — 심플 템플릿

숙박업주 등 비전문가 대상 프레젠테이션용. 큰 폰트, 넓은 여백, 슬라이드당 핵심 메시지 1개.

```
/onda-slides-simple 숙박업주 대상 2026년 1분기 매출 보고서, 슬라이드 5장

/onda-slides-simple 서비스 소개 덱. 표지, 핵심 가치, 주요 기능, 도입 효과, 문의
```
